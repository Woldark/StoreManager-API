...
Route::group(['prefix' => 'management'], function () {
	...
	Route::post('/building_edit', 'Admin\BuildingController@save_edit')->name('admin::buildings.edit');
	...
	Route::post('/floor_edit', 'Admin\FloorController@save_edit')->name('admin::floors.edit');
	...
	Route::post('/room_edit', 'Admin\RoomController@save_edit')->name('admin::rooms.edit');
	...
	Route::post('/responsible_edit', 'Admin\ResponsibleController@save_edit')->name('admin::responsibles.edit');
	...
	Route::post('/good_edit', 'Admin\GoodController@save_edit')->name('admin::goods.edit');
